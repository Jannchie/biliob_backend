...
public enum AuthorAchievementEnum {
     ...
     * desc: 描述
     */
    REDUCE_IN_DAY_LV9(4001, 9, "末日降临", "单日粉丝数减少超过 %,d", 50000L),
    REDUCE_IN_DAY_LV8(4002, 8, "雪崩来袭", "单日粉丝数减少超过 %,d", 20000L),
    REDUCE_IN_DAY_LV7(4003, 7, "断崖下跌", "单日粉丝数减少超过 %,d", 5000L),
    ...
    INCREASE_LV5(2001, 5, "人生巅峰", "单日涨粉达到前日的 %,d 倍", 100L),
    INCREASE_LV4(2002, 4, "尖峰时刻", "单日涨粉达到前日的 %,d 倍", 50L),
    INCREASE_LV3(2003, 3, "终于火了", "单日涨粉达到前日的 %,d 倍", 10L),
